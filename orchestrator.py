...
def run_once() -> None:
    ...
    # С 20 сентября 2026 format_consensus_note() возвращает None в скучном
    # случае "всё сошлось" (см. её докстринг) -- в консоли это по-прежнему
    # стоит видеть явно, просто другой фразой, а не None.
